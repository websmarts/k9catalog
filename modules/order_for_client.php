...
// 29/01/2014 added the following to show printed status order in pending list of MY ORDERS
...
if(is_array($printed_orders) ){
    if(is_array($new_orders)){
       $new_orders =  array_merge($new_orders,$printed_orders);
    } else {
        $new_orders = $printed_orders;
    }
}
// end addition

...
$_e = isset($req['e']) ? strtolower($req['e']) : '';
...
if ($S->isInternalUser()) {   // check to see if rep needs to record traveldata and if they have entered it for TODAY
...
} elseif ($S->role == "client") { // this happens when client does logout

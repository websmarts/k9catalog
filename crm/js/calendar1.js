...
*/
	var obj_calwindow = window.open(
		'calendar.html?datetime=' + this.dt_current.valueOf()+ '&id=' + this.id,
		'Calendar', 'width=200,height='+(this.time_comp ? 215 : 190)+
		',status=no,resizable=no,top=440,left=500,dependent=yes,alwaysRaised=yes'
	);
...
function cal_prs_date1 (str_date) {
	...
	var str_date_temp=arr_date_temp[2]+"/"+arr_date_temp[1]+"/"+arr_date_temp[0];
	var arr_date = str_date_temp.split('/');
